...
export const marcas = [
  ...
  console.log("el numero de marcas es :",contar,
    ...
    const productWithMaxQuantity = inventory.reduce((max, product) => {
        return product.quantity > max.quantity ? product : max;
      });
      
      console.log(`Producto con mayor existencia: ${productWithMaxQuantity.name}, Cantidad: ${productWithMaxQuantity.quantity}`);
...
console.log(mostCommonCity);  // La ciudad con más héroes